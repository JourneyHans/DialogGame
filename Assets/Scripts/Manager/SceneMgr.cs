...
//        GameManager.Instance.StartCoroutine(LoadSceneCoroutine(sceneName));
        ...
        _loadSceneRequest = SceneManager.LoadSceneAsync(sceneName, LoadSceneMode.Single);
        _loadSceneRequest.completed += OnSceneLoadComplete;
    }

    private void OnSceneLoadComplete(AsyncOperation asyncOperation)
    {
        _loadSceneRequest.allowSceneActivation = true;
        _loadSceneRequest.completed -= OnSceneLoadComplete;
        _loadSceneRequest = null;
