...
public class UIManager: Singleton<UIManager>
{
    ...
    private GameObject _canvasGameObject;       // UI_CanvasObject
    private GameObject _uiContainerGameObject;  // UI挂在点
    ...
    public void Init()
    {
        ...
        _uiContainerGameObject = GameObject.Find("UIRoot/Container");
    ...
    public T Show<T>(OpenType openType = OpenType.Add, SortOrderLayer layer = SortOrderLayer.HomePanel) where T : UIBase
    {
        ...
        else
        {
            ...
            uiGO.transform.SetParent(_uiContainerGameObject.transform, false);
